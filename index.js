...
const config = {
    A187: '📍SARAKINQUEIDE📍',
    instagram: 'https://instagram.com/vitinhoo__sillva?igshid=11wu45wwa61o2',
    nomer: 'wa.me/558298203606',
    aktif: '24 JAM',
   whatsapp: 'Message Vítor on WhatsApp. https://wa.me/message/5HZT32OUD47DP1',
...
client.on('message-new', async (m) => {
   ...
   switch (prefix) {
       case 'help':
           ...
           break
       case 'menu1':
           client.sendMessage(id, menu1.menu1(id, A187, tanggal, waktu, whatsapp, instagram, aktif, nomer, ontime), MessageType.text)
           break
       case 'menu2':
